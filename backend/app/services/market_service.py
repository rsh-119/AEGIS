...
# NOTE: "UITASBNK.NS" (below) is not a typo — it's the actual symbol IndianAPI's
# /stock resolves for Equitas Small Finance Bank. Their own data has this
# truncated ("EQ" dropped from "EQUITASBNK"); confirmed empirically that the
# real ticker returns "Stock not found" while this one returns the right company.
_MID_CAP_TICKERS = [
    "TVSMOTOR.NS","BALKRISIND.NS","ESCORTS.NS","CEATLTD.NS","ABFRL.NS",
    "CROMPTON.NS","BLUESTARCO.NS","VOLTAS.NS","WHIRLPOOL.NS","HAVELLS.NS",
    "KEI.NS","SUPREMEIND.NS","JKCEMENT.NS","RAMCOCEM.NS","AIAENG.NS",
    ...
    "BANDHANBNK.NS","IDFCFIRSTB.NS","AUBANK.NS","UJJIVANSFB.NS","UITASBNK.NS",
    "SJVN.NS","NHPC.NS","CESC.NS","TORNTPOWER.NS","IREDA.NS","JSWENERGY.NS",
    "PIIND.NS","SYNGENE.NS","BIOCON.NS","AUROPHARMA.NS","LUPIN.NS",
    "UNITDSPR.NS","RADICO.NS","VBL.NS","EMAMILTD.NS","JYOTHYLAB.NS",
...
_SMALL_CAP_TICKERS = [
    ...
    "ZENSARTECH.NS","MASTEK.NS","CYIENT.NS","BSOFT.NS","INTELLECT.NS","NEWGEN.NS",
    "PGHH.NS","ZYDUSWELL.NS","GOCOLORS.NS","VAIBHAVGBL.NS",
    "INOXWIND.NS","PVRINOX.NS","NCLIND.NS","EMBDL.NS","ARVSMART.NS",
